...
class Model_Main extends Model{
    ...
    public function list_start(){
        ...
        $recommenation_query=$this->pdo->query("SELECT id, name, image, price  FROM products where id_category in (select id from category where disabled=0) order by rand() limit 40");

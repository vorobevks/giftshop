            ...
            <div class="modal">
                <div class="modal-registration modal-dialog">
                    ...
                    <form id="reg_form" action="/logon/reg" method="POST">
                        ...
                        <input type="text" id="login" name="login" placeholder='Ваш логин'><i id="user_ok" class="hidden icon_green fas fa-check-circle"></i><i id="user_wrong" class="hidden icon_red fas fa-times-circle" title="Пользователь с таким именем уже существует"></i><br>
